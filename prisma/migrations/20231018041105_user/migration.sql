...
CREATE TABLE `users` (
    ...
    `role` ENUM('user', 'pekerja', 'owner') NOT NULL,
...
-- AddForeignKey
ALTER TABLE `kambing` ADD CONSTRAINT `kambing_id_kandang_fkey` FOREIGN KEY (`id_kandang`) REFERENCES `kandang`(`id_kandang`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `pakan` ADD CONSTRAINT `pakan_id_user_fkey` FOREIGN KEY (`id_user`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `pakan` ADD CONSTRAINT `pakan_id_kandang_fkey` FOREIGN KEY (`id_kandang`) REFERENCES `kandang`(`id_kandang`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `mq135` ADD CONSTRAINT `mq135_id_kandang_fkey` FOREIGN KEY (`id_kandang`) REFERENCES `kandang`(`id_kandang`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `dht22` ADD CONSTRAINT `dht22_id_kandang_fkey` FOREIGN KEY (`id_kandang`) REFERENCES `kandang`(`id_kandang`) ON DELETE SET NULL ON UPDATE CASCADE;
